 ...
 * Displays and manages laboratory working hours with auto-save
 */
const WorkingHoursSection = () => {
  const { workingHours, error, success, updateWorkingHours } = useLaboratoryProfile({
    autoFetch: false,
  });
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-teal-50 text-sm mt-1">أوقات عمل المختبر خلال الأسبوع</p>
            </div>
          </div>
