 ...
 * Displays and manages laboratory address with map picker and auto-save
 */
const AddressSection = () => {
  const { address, error, success, updateAddress } = useLaboratoryProfile({
    autoFetch: false,
  });
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-teal-50 text-sm mt-1">موقع المختبر على الخريطة</p>
            </div>
          </div>
      ...
      <div className="p-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-2">
            انقر على الخريطة لتحديد موقع المختبر بدقة
          </p>
        </div>
