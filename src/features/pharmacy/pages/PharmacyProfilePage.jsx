 ...
 * Main page for pharmacy profile management with tabbed interface
 */
const PharmacyProfilePage = () => {
  ...
  const tabs = [
    ...
    { id: 'delivery', label: 'التوصيل', icon: FaTruck },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50/30 to-emerald-50/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 text-lg">إدارة معلومات الصيدلية</p>
        </div>
